    ...
    >
        ...
        >
            <SliderRange
                ...
                :class="cn('absolute h-full', props.rangeClass)"
            />
        </SliderTrack>
        ...
        <SliderThumb
            ...
            :class="
                cn(
                    'block h-5 w-5 rounded-full bg-white shadow focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
