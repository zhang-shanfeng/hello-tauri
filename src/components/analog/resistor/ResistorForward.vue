...
<template>
    <Card
        class="w-full shadow-lg border border-gray-200/70 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden rounded-xl py-0">
        <CardFeatureHeader title="电阻并联计算器" description="Parallel Resistor Calculator" />
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 p-4  h-full shadow-lg overflow-hidden">
            <div class="lg:col-span-5 flex flex-col">
                <div
                    class=" dark:bg-zinc-900 rounded-xl shadow-md border border-slate-200 dark:border-zinc-800 flex flex-col h-full overflow-hidden transition-all hover:shadow-lg">
                    ...
                    <div class="p-6 space-y-6 flex-1">
                        <div class="space-y-2">
                            <label for="resistor-input"
                                ...
                                请输入各个电阻值
                                <span class="text-xs text-slate-400 dark:text-zinc-500 font-normal ml-1">(单位: 欧姆
                                    Ω)</span>
                            </label>
                ...
                <div
                    ...
                    <div class="grid grid-cols-1  gap-4 flex-1">
                        <div
                            ...
                            <div
                                class="flex items-center gap-2 text-emerald-700 dark:text-emerald-400 font-bold text-sm">
                        ...
                        <div
                            ...
                            <ul
                                class="text-xs text-slate-600 dark:text-zinc-400 space-y-2 list-disc list-inside leading-relaxed">
                                <li><strong class="text-slate-800 dark:text-zinc-200">短路致命性：</strong>只要其中任何一个电阻意外发生物理短路
                                    (0
                                    Ω)，<span class="text-amber-600 font-medium">整个并联网络将全部被短路</span>。</li>
                                <li><strong class="text-slate-800 dark:text-zinc-200">BOM
                                        成本与空间：</strong>并联需要放置更多的元器件，会增加
